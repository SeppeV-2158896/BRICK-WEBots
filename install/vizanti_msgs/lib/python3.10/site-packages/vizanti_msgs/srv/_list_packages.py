...
class Metaclass_ListPackages_Event(type):
    """Metaclass of message 'ListPackages_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__list_packages__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__list_packages__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__list_packages__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__list_packages__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__list_packages__event
...
class ListPackages_Event(metaclass=Metaclass_ListPackages_Event):
    """Message class 'ListPackages_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<vizanti_msgs/ListPackages_Request, 1>',
        'response': 'sequence<vizanti_msgs/ListPackages_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['vizanti_msgs', 'srv'], 'ListPackages_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['vizanti_msgs', 'srv'], 'ListPackages_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from vizanti_msgs.srv import ListPackages_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListPackages_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ListPackages_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from vizanti_msgs.srv import ListPackages_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListPackages_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ListPackages_Response'"
...
class Metaclass_ListPackages(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _list_packages.Metaclass_ListPackages_Event._TYPE_SUPPORT is None:
                _list_packages.Metaclass_ListPackages_Event.__import_type_support__()
...
class ListPackages(metaclass=Metaclass_ListPackages):
    ...
    from vizanti_msgs.srv._list_packages import ListPackages_Event as Event
