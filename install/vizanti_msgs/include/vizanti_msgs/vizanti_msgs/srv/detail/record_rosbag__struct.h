...
enum
{
  vizanti_msgs__srv__RecordRosbag_Event__request__MAX_SIZE = 1
};
// response
enum
{
  vizanti_msgs__srv__RecordRosbag_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/RecordRosbag in the package vizanti_msgs.
typedef struct vizanti_msgs__srv__RecordRosbag_Event
{
  service_msgs__msg__ServiceEventInfo info;
  vizanti_msgs__srv__RecordRosbag_Request__Sequence request;
  vizanti_msgs__srv__RecordRosbag_Response__Sequence response;
} vizanti_msgs__srv__RecordRosbag_Event;

// Struct for a sequence of vizanti_msgs__srv__RecordRosbag_Event.
typedef struct vizanti_msgs__srv__RecordRosbag_Event__Sequence
{
