...
[[deprecated("use vizanti_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const vizanti_msgs::srv::SaveMap_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  vizanti_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use vizanti_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const vizanti_msgs::srv::SaveMap_Event & msg)
{
  return vizanti_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<vizanti_msgs::srv::SaveMap_Event>()
{
  return "vizanti_msgs::srv::SaveMap_Event";
}

template<>
inline const char * name<vizanti_msgs::srv::SaveMap_Event>()
{
  return "vizanti_msgs/srv/SaveMap_Event";
}

template<>
struct has_fixed_size<vizanti_msgs::srv::SaveMap_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<vizanti_msgs::srv::SaveMap_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<vizanti_msgs::srv::SaveMap_Request>::value && has_bounded_size<vizanti_msgs::srv::SaveMap_Response>::value> {};

template<>
struct is_message<vizanti_msgs::srv::SaveMap_Event>
  : std::true_type {};
