...
#ifndef VIZANTI_MSGS__SRV__DETAIL__LIST_PACKAGES__TYPE_SUPPORT_H_
#define VIZANTI_MSGS__SRV__DETAIL__LIST_PACKAGES__TYPE_SUPPORT_H_
...
#endif  // VIZANTI_MSGS__SRV__DETAIL__LIST_PACKAGES__TYPE_SUPPORT_H_
