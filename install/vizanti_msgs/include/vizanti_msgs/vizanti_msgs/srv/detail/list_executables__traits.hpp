...
inline void to_flow_style_yaml(
  const ListExecutables_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const ListExecutables_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use vizanti_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const vizanti_msgs::srv::ListExecutables_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  vizanti_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use vizanti_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const vizanti_msgs::srv::ListExecutables_Event & msg)
{
  return vizanti_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<vizanti_msgs::srv::ListExecutables_Event>()
{
  return "vizanti_msgs::srv::ListExecutables_Event";
}

template<>
inline const char * name<vizanti_msgs::srv::ListExecutables_Event>()
{
  return "vizanti_msgs/srv/ListExecutables_Event";
}

template<>
struct has_fixed_size<vizanti_msgs::srv::ListExecutables_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<vizanti_msgs::srv::ListExecutables_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<vizanti_msgs::srv::ListExecutables_Request>::value && has_bounded_size<vizanti_msgs::srv::ListExecutables_Response>::value> {};

template<>
struct is_message<vizanti_msgs::srv::ListExecutables_Event>
  : std::true_type {};
