...
{
public:
  explicit Init_LoadMap_Event_response(::vizanti_msgs::srv::LoadMap_Event & msg)
  : msg_(msg)
  {}
  ::vizanti_msgs::srv::LoadMap_Event response(::vizanti_msgs::srv::LoadMap_Event::_response_type arg)
  {
...
private:
  ::vizanti_msgs::srv::LoadMap_Event msg_;
};

class Init_LoadMap_Event_request
{
public:
  explicit Init_LoadMap_Event_request(::vizanti_msgs::srv::LoadMap_Event & msg)
  : msg_(msg)
  {}
  Init_LoadMap_Event_response request(::vizanti_msgs::srv::LoadMap_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_LoadMap_Event_request info(::vizanti_msgs::srv::LoadMap_Event::_info_type arg)
  {
...
template<>
inline
auto build<::vizanti_msgs::srv::LoadMap_Event>()
{
  return vizanti_msgs::srv::builder::Init_LoadMap_Event_info();
}
