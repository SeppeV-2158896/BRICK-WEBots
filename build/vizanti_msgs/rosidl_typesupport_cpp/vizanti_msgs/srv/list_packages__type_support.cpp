...
static const _ListPackages_Request_type_support_symbol_names_t _ListPackages_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vizanti_msgs, srv, ListPackages_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vizanti_msgs, srv, ListPackages_Request)),
  }
};
...
{
  return &::vizanti_msgs::srv::rosidl_typesupport_cpp::ListPackages_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vizanti_msgs, srv, ListPackages_Request)() {
  return get_message_type_support_handle<vizanti_msgs::srv::ListPackages_Request>();
}
...
static const _ListPackages_Response_type_support_symbol_names_t _ListPackages_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vizanti_msgs, srv, ListPackages_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vizanti_msgs, srv, ListPackages_Response)),
  }
};
...
{
  return &::vizanti_msgs::srv::rosidl_typesupport_cpp::ListPackages_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vizanti_msgs, srv, ListPackages_Response)() {
  return get_message_type_support_handle<vizanti_msgs::srv::ListPackages_Response>();
}
...
typedef struct _ListPackages_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _ListPackages_Event_type_support_ids_t;

static const _ListPackages_Event_type_support_ids_t _ListPackages_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _ListPackages_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _ListPackages_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _ListPackages_Event_type_support_symbol_names_t _ListPackages_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vizanti_msgs, srv, ListPackages_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vizanti_msgs, srv, ListPackages_Event)),
  }
};

typedef struct _ListPackages_Event_type_support_data_t
{
  void * data[2];
} _ListPackages_Event_type_support_data_t;

static _ListPackages_Event_type_support_data_t _ListPackages_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _ListPackages_Event_message_typesupport_map = {
  2,
  "vizanti_msgs",
  &_ListPackages_Event_message_typesupport_ids.typesupport_identifier[0],
  &_ListPackages_Event_message_typesupport_symbol_names.symbol_name[0],
  &_ListPackages_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t ListPackages_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_ListPackages_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::vizanti_msgs::srv::rosidl_typesupport_cpp::ListPackages_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vizanti_msgs, srv, ListPackages_Event)() {
  return get_message_type_support_handle<vizanti_msgs::srv::ListPackages_Event>();
}
...
static const _ListPackages_type_support_symbol_names_t _ListPackages_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vizanti_msgs, srv, ListPackages)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vizanti_msgs, srv, ListPackages)),
  }
};
...
static const rosidl_service_type_support_t ListPackages_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<vizanti_msgs::srv::ListPackages_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<vizanti_msgs::srv::ListPackages_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<vizanti_msgs::srv::ListPackages_Event>(),
...
{
  return &::vizanti_msgs::srv::rosidl_typesupport_cpp::ListPackages_service_type_support_handle;
}
