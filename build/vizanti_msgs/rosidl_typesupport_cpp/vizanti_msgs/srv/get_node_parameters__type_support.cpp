...
static const _GetNodeParameters_Event_type_support_symbol_names_t _GetNodeParameters_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vizanti_msgs, srv, GetNodeParameters_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vizanti_msgs, srv, GetNodeParameters_Event)),
  }
};
...
{
  return &::vizanti_msgs::srv::rosidl_typesupport_cpp::GetNodeParameters_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vizanti_msgs, srv, GetNodeParameters_Event)() {
  return get_message_type_support_handle<vizanti_msgs::srv::GetNodeParameters_Event>();
}
...
static const rosidl_service_type_support_t GetNodeParameters_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<vizanti_msgs::srv::GetNodeParameters_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<vizanti_msgs::srv::GetNodeParameters_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<vizanti_msgs::srv::GetNodeParameters_Event>(),
