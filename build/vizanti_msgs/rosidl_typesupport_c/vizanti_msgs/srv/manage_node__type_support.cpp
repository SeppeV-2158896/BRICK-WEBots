...
static const _ManageNode_Event_type_support_symbol_names_t _ManageNode_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vizanti_msgs, srv, ManageNode_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vizanti_msgs, srv, ManageNode_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vizanti_msgs, srv, ManageNode_Event)() {
  return &::vizanti_msgs::srv::rosidl_typesupport_c::ManageNode_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t ManageNode_service_type_support_handle = {
  ...
  &ManageNode_Request_message_type_support_handle,
  &ManageNode_Response_message_type_support_handle,
  &ManageNode_Event_message_type_support_handle,
