...
static const _ListPackages_Event_type_support_symbol_names_t _ListPackages_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vizanti_msgs, srv, ListPackages_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vizanti_msgs, srv, ListPackages_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vizanti_msgs, srv, ListPackages_Event)() {
  return &::vizanti_msgs::srv::rosidl_typesupport_c::ListPackages_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t ListPackages_service_type_support_handle = {
  ...
  &ListPackages_Request_message_type_support_handle,
  &ListPackages_Response_message_type_support_handle,
  &ListPackages_Event_message_type_support_handle,
