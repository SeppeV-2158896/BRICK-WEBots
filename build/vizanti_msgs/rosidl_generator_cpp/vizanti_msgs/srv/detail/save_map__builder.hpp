...
{
public:
  explicit Init_SaveMap_Event_response(::vizanti_msgs::srv::SaveMap_Event & msg)
  : msg_(msg)
  {}
  ::vizanti_msgs::srv::SaveMap_Event response(::vizanti_msgs::srv::SaveMap_Event::_response_type arg)
  {
...
private:
  ::vizanti_msgs::srv::SaveMap_Event msg_;
};

class Init_SaveMap_Event_request
{
public:
  explicit Init_SaveMap_Event_request(::vizanti_msgs::srv::SaveMap_Event & msg)
  : msg_(msg)
  {}
  Init_SaveMap_Event_response request(::vizanti_msgs::srv::SaveMap_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SaveMap_Event_request info(::vizanti_msgs::srv::SaveMap_Event::_info_type arg)
  {
...
template<>
inline
auto build<::vizanti_msgs::srv::SaveMap_Event>()
{
  return vizanti_msgs::srv::builder::Init_SaveMap_Event_info();
}
