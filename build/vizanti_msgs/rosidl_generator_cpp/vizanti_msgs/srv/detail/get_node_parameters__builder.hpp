...
class Init_GetNodeParameters_Event_response
{
public:
  explicit Init_GetNodeParameters_Event_response(::vizanti_msgs::srv::GetNodeParameters_Event & msg)
  : msg_(msg)
  {}
  ::vizanti_msgs::srv::GetNodeParameters_Event response(::vizanti_msgs::srv::GetNodeParameters_Event::_response_type arg)
  {
...
private:
  ::vizanti_msgs::srv::GetNodeParameters_Event msg_;
};

class Init_GetNodeParameters_Event_request
{
public:
  explicit Init_GetNodeParameters_Event_request(::vizanti_msgs::srv::GetNodeParameters_Event & msg)
  : msg_(msg)
  {}
  Init_GetNodeParameters_Event_response request(::vizanti_msgs::srv::GetNodeParameters_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GetNodeParameters_Event_response(msg_);
  }
...
class Init_GetNodeParameters_Event_info
{
public:
  Init_GetNodeParameters_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetNodeParameters_Event_request info(::vizanti_msgs::srv::GetNodeParameters_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GetNodeParameters_Event_request(msg_);
  }
...
template<>
inline
auto build<::vizanti_msgs::srv::GetNodeParameters_Event>()
{
  return vizanti_msgs::srv::builder::Init_GetNodeParameters_Event_info();
}
