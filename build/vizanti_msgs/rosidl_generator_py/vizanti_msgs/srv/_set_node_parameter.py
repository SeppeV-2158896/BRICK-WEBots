...
class Metaclass_SetNodeParameter_Event(type):
    """Metaclass of message 'SetNodeParameter_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_node_parameter__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_node_parameter__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_node_parameter__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_node_parameter__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_node_parameter__event
...
class SetNodeParameter_Event(metaclass=Metaclass_SetNodeParameter_Event):
    """Message class 'SetNodeParameter_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<vizanti_msgs/SetNodeParameter_Request, 1>',
        'response': 'sequence<vizanti_msgs/SetNodeParameter_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['vizanti_msgs', 'srv'], 'SetNodeParameter_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['vizanti_msgs', 'srv'], 'SetNodeParameter_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from vizanti_msgs.srv import SetNodeParameter_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetNodeParameter_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetNodeParameter_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from vizanti_msgs.srv import SetNodeParameter_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetNodeParameter_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetNodeParameter_Response'"
...
class Metaclass_SetNodeParameter(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_node_parameter.Metaclass_SetNodeParameter_Event._TYPE_SUPPORT is None:
                _set_node_parameter.Metaclass_SetNodeParameter_Event.__import_type_support__()
...
class SetNodeParameter(metaclass=Metaclass_SetNodeParameter):
    ...
    from vizanti_msgs.srv._set_node_parameter import SetNodeParameter_Event as Event
