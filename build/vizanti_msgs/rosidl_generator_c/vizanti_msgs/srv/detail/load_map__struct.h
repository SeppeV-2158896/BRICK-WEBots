...
enum
{
  vizanti_msgs__srv__LoadMap_Event__request__MAX_SIZE = 1
};
// response
enum
{
  vizanti_msgs__srv__LoadMap_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/LoadMap in the package vizanti_msgs.
typedef struct vizanti_msgs__srv__LoadMap_Event
{
  service_msgs__msg__ServiceEventInfo info;
  vizanti_msgs__srv__LoadMap_Request__Sequence request;
  vizanti_msgs__srv__LoadMap_Response__Sequence response;
} vizanti_msgs__srv__LoadMap_Event;

// Struct for a sequence of vizanti_msgs__srv__LoadMap_Event.
typedef struct vizanti_msgs__srv__LoadMap_Event__Sequence
{
