...
class navigation(Node):
    def __init__(self):
        ...
        self.orientation_pid = PIDController(1, 10, 0.01, self.timeStep/1000.0)
    ...
    def path_callback(self, path_msg):
        ...
        self.get_logger().info("path " + str(len(self.path_queue)))
        for _ in range(10):
            if self.path_queue:
    ...
    def move_to_goal(self,odom):
        ...
        if(len(self.path_queue) > 0):
            ...
            if abs(self.calculate_position_error(self.path_queue[-1],position)) < 0.25:
                self.path_queue = []
            ...
            self.get_logger().info("orientation: " + str(yaw) + "  goal: " + str(goal_orientation))
            ...
            angularvel = (angularvel*(22/7))/180*2
